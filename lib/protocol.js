...
var Protocol = {
    ...
    encodeResponse: function (data) {
        ...
        var buf = put().put(Buffer.from('Bin', 'ascii')).word8(0x01).word32be(body.length).buffer();
    ...
    encodeStruct: function (obj) {
        ...
        var header = put().word32be(0x101).word32be(i).buffer();
        return Buffer.concat([header, content]);
    },
    /**
     * encode struct key
    ...
    encodeStructKey: function (str) {
        ...
        return put().word32be(str.length).put(Buffer.from(str, 'ascii')).buffer();
    },
    /**
     * encode array
    ...
    encodeArray: function (arr) {
        ...
        buf = put().word32be(0x100).word32be(arrLength).buffer();
    ...
    encodeString: function (str) {
        ...
        return put().word32be(0x0003).word32be(str.length).put(Buffer.from(str, 'ascii')).buffer();
    },
    /**
     * encode bool
     * @param {*} b any type
    ...
    encodeInteger: function (i) {
        ...
        return put().word32be(0x01).word32be(i).buffer();
    },
    /**
     * encode double
    ...
    encodeDouble: function (d) {
        ...
        return put().word32be(0x04).word32be(man).word32be(exp).buffer();
    },
    /**
     * decode double
    ...
    decodeDouble: function (elem) {
        ...
        var flt = binary
            ...
            .word32bs('mantissa')
            .word32bs('exponent')
            .buffer('rest', elem.length - 8).vars;
    ...
    decodeString: function (elem) {
        ...
        var str = binary
            ...
            .buffer('rest', elem.length - 4).vars;
    ...
    decodeBool: function (elem) {
        ...
        var res = binary
            .parse(elem)
            .word8('value')
            .buffer('rest', elem.length - 1).vars;
    ...
    decodeArray: function (elem) {
        ...
        var arr = binary
            ...
            .buffer('elements', elem.length - 4).vars;
        ...
        for (var i = 0; i < struct.elementCount; i++) {
            var key = binary
                ...
                .buffer(
                    'rest',
                    elements.length - 4,
                ) // length is bigger than buffer - doesn't matter
            .vars;
            elements = key.rest;
    ...
    decodeData: function (data) {
        ...
        var res = binary.parse(data).word32bu('dataType').buffer('elements', data.length).vars;
        if (!res || !res.dataType) {
