...
var Protocol = {
    ...
    decodeData: function (data) {
        ...
        // truncated payloads must not reach the decoders, whose documented
        // contract is to throw on short buffers - this runs inside socket
        // data handlers
        var minLength = dataType === 0x04 ? 8 : dataType === 0x02 ? 1 : 4;
        if (elements.length < minLength) {
            console.log('<-- binrpc error: truncated data of type ' + dataType.toString(16) + ' :(');
            return;
        }
