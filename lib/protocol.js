...
var Protocol = {
    ...
    encodeRequest: function (method, data) {
        if (typeof method !== 'string') throw new TypeError('argument \'method\' must be type string');
        if (method === '') throw new Error('argument \'method\' is not allowed to be empty');
    ...
    encodeData: function (obj) {
        ...
        if (objType === 'undefined' || obj === null) throw new TypeError('argument \'obj\' must be type number, string, boolean or object');
        switch (objType) {
            case 'number':
                if ((obj % 1 !== 0) || obj.double) {
            ...
            case 'object':
                if (Object.prototype.toString.call(obj) === '[object Array]') {
                    ...
                    if (typeof obj.explicitDouble === 'number') {       // deprecated?
    ...
    encodeStruct: function (obj) {
        if (typeof obj !== 'object') throw new TypeError('argument \'d\' must be an object');
        var i = 0;
        var content = new Buffer(0);
        for (var key in obj) {
    ...
    encodeStructKey: function (str) {
        if (typeof str !== 'string') throw new TypeError('argument \'d\' must be a string');
        return Put()
            .word32be(str.length)
    ...
    encodeArray: function (arr) {
        if (Object.prototype.toString.call(arr) !== '[object Array]') throw new TypeError('argument \'d\' must be an array');
        var buf,
    ...
    encodeInteger: function (i) {
        if (typeof i !== 'number') throw new TypeError('argument \'i\' must be a number');
        if (i < -2147483648 || i > 2147483647) throw new RangeError('argument \'i\' must be between -2147483648 and 2147483647');
        return Put()
            .word32be(0x01)
            .word32be(i)
            .buffer()
    ...
    encodeDouble: function (d) {
        if (typeof d !== 'number') throw new TypeError('argument \'d\' must be a number');
    ...
    decodeDouble: function (elem) {
        if (!(elem instanceof Buffer)) throw new TypeError('argument \'elem\' must be an instance of Buffer');
        if (elem.length < 8) throw new Error('argument \'elem\' length must be >= 8');
    ...
    decodeString: function (elem) {
        if (!(elem instanceof Buffer)) throw new TypeError('argument \'elem\' must be an instance of Buffer');
        if (elem.length < 4) throw new Error('argument \'elem\' length must be >= 4');
    ...
    decodeBool: function (elem) {
        if (!(elem instanceof Buffer)) throw new TypeError('argument \'elem\' must be an instance of Buffer');
        if (elem.length < 1) throw new Error('argument \'elem\' length must be >= 4');
    ...
    decodeInteger: function (elem) {
        ...
        var int = binary.parse(elem)
            ...
            .vars
            ;
        if (int.value & 0x80000000) int.value = int.value - 0x100000000;
