    ...
    this.server = net.createServer(function (c) {
        ...
        c.on('data', function (data) {
            ...
            if (receiver.length >= (length + 8)) {
                ...
                var res = that.emit(request.method, request.params, function (response) {
                    if (response) c.write(Binrpc.buildResponse(response));
                });
                if (!res) {
...
var Binrpc = {
    ...
    request: function (host, port, method, data, callback) {
        //console.log("--> "+this.options.ccuIp+":"+port+" request " + method + " " + JSON.stringify(data));
    ...
    parseData: function (data) {
        ...
        switch (res.dataType) {
            ...
            case 0x100:
                ...
                break;
            case 0x04:
                return this.parseFloat(res.elements);
                break;
            case 0x03:
    ...
    sendRequest: function (host, port, buf, callback) {
        ...
        client.on('data', function(data) {
            ...
            //console.log("chunk= " + chunk + " response.length="+response.length+ " length=" + length);
